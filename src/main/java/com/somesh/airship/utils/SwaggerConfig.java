...
public class SwaggerConfig {
	...
	public static final Contact DEFAULT_CONTACT = new Contact("Somesh", "", "somesh.kandula@gmail.com");

	public static final ApiInfo DEFAULT_API_INFO = new ApiInfo("SCM API", "Create and Track shipments", "1.0",
